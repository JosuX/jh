    ...
    return (
        <header className="relative z-10 w-full h-screen flex items-center justify-center overflow-hidden">
            ...
            <div className="relative z-10 flex flex-col items-center drop-shadow-[0_4px_20px_rgba(0,0,0,1)]">
                ...
                <p className="font-oswald text-white text-[clamp(11px,2.5vw,30px)] tracking-[0.5em] font-light mb-5">
                    THE WEDDING OF
                </p>
                <h1 className="font-italianno text-white text-[clamp(55px,15vw,200px)] tracking-widest leading-none mb-8 md:mb-20">
                    Jofer{" "}
                ...
                <time className="text-white text-[10px] md:text-[28px] font-oswald tracking-[0.2em] font-light" dateTime="2026-03-07">
